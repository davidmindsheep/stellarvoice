...
export const blogPosts = {
    '5-minute-window-speed-to-lead': {
        ...
        sections: [
            ...
            { type: 'visual', label: 'The multi-vendor race', description: 'A diagram showing a buyer contacting four businesses; the one that responds first wins the booking while the slower three lose out. 78% of buyers purchase from the first business to respond.' },
            ...
            { type: 'visual', label: '9-to-5 human team vs always-on AI', description: 'A split-scene illustration: an overworked human after-hours team with calls piling up, versus an always-on AI agent calmly handling every call.' },
    ...
    'every-missed-call-is-a-lost-customer': {
        ...
        sections: [
            ...
            { type: 'visual', label: 'What really happens to a missed call', description: 'A decision flowchart: an answered call leads to BOOKED; an unanswered call branches into hang-ups, no callbacks, and calls to competitors.' },
            ...
            { type: 'visual', label: 'Leaky bucket vs sealed funnel', description: 'Before and after illustration: a leaking bucket of calls becomes a sealed bucket where an AI agent captures every call into the calendar.' },
    ...
    'are-my-clients-too-old-for-ai': {
        ...
        sections: [
            ...
            { type: 'visual', label: 'Natural AI vs traditional IVR', description: 'Horizontal bar comparison: natural AI voice agent 3.8 / 5 vs traditional IVR phone menu 2.1 / 5. Overall AI voice satisfaction: 53% to 72% in three years.' },
            ...
            { type: 'visual', label: 'Resistance fades with exposure', description: 'Two lines over 12 weeks: comfort and ease of use rises, privacy concern falls. The lines cross midway. End annotation: 90% found it easy to use.' },
    ...
    'easystart-homes-speed-to-lead-projection': {
        ...
        sections: [
            ...
            { type: 'visual', label: 'The EasyStart engagement so far', description: 'Horizontal timeline: Dec 2025 Pilot (60 leads, 10 bookings, 16.7%) -> Jan 2026 Live -> Jan-May 2026 50-100 leads/mo, 17-25% booking rate, 6+ months live.' },
            ...
            { type: 'visual', label: 'Current vs with speed-to-lead', description: 'Two side-by-side sales funnels. Current (delayed cadence): Lead in -> Contacted 30-40% -> Booked 17-25%. With speed-to-lead: Lead in -> Contacted 60-75% -> Booked 28-40%.' },
            ...
            { type: 'visual', label: 'Extra bookings per month', description: 'Callout: 13-19 bookings/mo now arrow to 21-30 with speed-to-lead. Badge: +8 to 11 extra qualified bookings. Same leads, no extra ad spend.' },
    ...
    'real-cost-of-slow-follow-up': {
        ...
        sections: [
            ...
            { type: 'visual', label: 'How the leaks compound', description: 'One lead enters and passes three gates: Answered in time? Call picked up? Covered after hours? At each gate a portion drops away, leaving a thin captured stream.' },
            ...
            { type: 'visual', label: 'Three leaks vs one sealed system', description: 'Before/after: a leaking pipe with three labelled holes (slow response, missed calls, after hours) becomes a sealed pipe delivering full flow into a calendar booking.' },
