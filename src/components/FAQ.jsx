...
const faqs = [
    ...
    { question: 'What does it cost?', answer: 'Outbound Sales Qualifier and Dead Lead Reactivation run on a low monthly base plus a per-appointment fee, so the bulk of what you pay only kicks in once we book qualified meetings. The Inbound Sales Qualifier is a flat monthly plan. Visit our pricing page for the full breakdown, or book a call and we will build a custom package.' },
